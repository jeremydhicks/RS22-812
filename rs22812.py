'''
rs22812.py ported to Python 3 and a modern version of PySerial, the only 
3rd party dependency.  No GUI provided.  The original header from Don 
Peterson is below.
...
class RS22812:
    ...
    def __init__(self, com_port=3):
        ...
        baudrate = 4800
        self.sp = serial.Serial(f'COM{com_port}', baudrate, timeout=0)
    ...
    def InterpretReading(self, bytes):
